...
In our test data, the optimal input would be around 2,000 seeds, much lower than the global overcompression value of 33,750 seeds. We can see a similar result the below data from Cole et. al 2017's mouse wildtype data:


insert find_best_nseed, DMR num vs. num seed, time vs. num seed
...
Cole and Aaron seeds vs hit DMRs
